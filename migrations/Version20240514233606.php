...
final class Version20240514233606 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE joboffer (id INT AUTO_INCREMENT NOT NULL, recruiter_id INT DEFAULT NULL, jobTitle VARCHAR(30) NOT NULL, workplace VARCHAR(100) NOT NULL, description LONGTEXT NOT NULL, is_valid TINYINT(1) NOT NULL, salary INT NOT NULL, schedule INT NOT NULL, consultant_id INT DEFAULT NULL, INDEX IDX_288A3A4E44F779A2 (consultant_id), INDEX IDX_288A3A4EBB0859F1 (recruteur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

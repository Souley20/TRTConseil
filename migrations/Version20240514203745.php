 ...
 */
final class Version20240514203745 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE candidacy (id INT AUTO_INCREMENT NOT NULL, candidate_id INT DEFAULT NULL, joboffer_id INT DEFAULT NULL, is_valid TINYINT(1) DEFAULT NULL, INDEX IDX_D930569D91BD8781 (candidate_id), INDEX IDX_D930569D3481D195 (joboffer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_0900_ai_ci` ENGINE = MyISAM COMMENT = \'\' ');

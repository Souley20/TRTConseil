 ...
 */
final class Version20240514212132 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE job_offer ADD consultant_id INT DEFAULT NULL, ADD recruteur_id INT DEFAULT NULL, CHANGE description description VARCHAR(255) NOT NULL');
        $this->addSql('CREATE INDEX IDX_288A3A4E44F779A2 ON job_offer (consultant_id)');
        $this->addSql('CREATE INDEX IDX_288A3A4E156BE243 ON job_offer (recruteur_id)');
        ...
        $this->addSql('ALTER TABLE candidature ADD candidate_id INT DEFAULT NULL, ADD job_offer_id INT DEFAULT NULL');
        $this->addSql('CREATE INDEX IDX_D930569D91BD8781 ON candidature (candidate_id)');
        $this->addSql('CREATE INDEX IDX_D930569D3481D195 ON candidature (job_offer_id)');
